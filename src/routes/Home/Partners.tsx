    ...
    return (
        <div className="Partners">
            ...
            <div className='column'>
                {Array.from(partnerArray.entries()).map(([index, partner]) => (
                    <div className='row partner' style={{ flexDirection: (isEven(index) ? 'row' : 'row-reverse') }}>
